...
import com.yc.test.dao.IGoodsInfoDao;
...
public class GoodsInfoDaoImpl implements IGoodsInfoDao{
	...
	public List<GoodsInfo> findIndex() {
		DBHelper db = new DBHelper();
		String sql = "select gno,gname,price,tno,pics from goodsinfo g1 where 4 > (select count(gno) from goodsinfo g2 where g1.tno=g2.tno and g1.gno < g2.gno) order by g1.tno asc,g1.gno desc";
